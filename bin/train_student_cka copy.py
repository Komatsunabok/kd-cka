...
def parse_option():
    ...
    # CKAD
    parser.add_argument('--group_num', type=int, default=3, help='number of groups for CKA')
    parser.add_argument('--method', type=str, default='mean', choices=['mean', 'max', 'min'], help='method for CKA')
    parser.add_argument('--reduction', type=str, default='sum', choices=['sum', 'mean'], help='reduction method for CKA loss')
